...
class Category(models.Model):
    ...
    avatar = models.ImageField(verbose_name=_(
        "avatar"), blank=True, null=True, upload_to='categories/%Y/%m/%d/')
...
class Product(models.Model):
    ...
    caption = models.TextField(verbose_name=_(
        'caption'), blank=True, max_length=1024, null=True)
    ...
    categories = models.ManyToManyField(
        'Category', related_name='categor', verbose_name=_("categories"), blank=True)
    create_time = models.DateTimeField(
        verbose_name=_("create time"), auto_now_add=True)
    update_time = models.DateTimeField(
        verbose_name=_("update time"), auto_now=True)
...
class Post_File(models.Model):
    ...
    post = models.ForeignKey('Product', verbose_name=_(
